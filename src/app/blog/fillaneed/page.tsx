import { KeyRound, Scroll } from "lucide-react";
...
const BlogPage = () => {
  return (
    <div className="blog mt-8 w-full font-sans">
      <div>
        <div className="flex w-full items-center justify-between gap-2">
          <h1>Fillaneed</h1>
          <Link
            className="font-serif text-lg italic text-blue-700 underline"
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="mt-2 block">
            <p className="inline">
              ...
              ideating, designing and prototyping a small wishlist builder that
              would eventually scope-creep itself into a full fledged
