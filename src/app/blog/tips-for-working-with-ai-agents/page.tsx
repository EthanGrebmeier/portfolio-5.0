...
const BlogPage = async ({ searchParams }: BlogPageProps) => {
  ...
  const isAsmbl = resolvedSearchParams.isAsmbl !== undefined;
        ...
        <div className="blog">
          <section className="mt-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                You give them a task, they navigate your codebase, make
                thoughtful changes, and hand back something that looks like it
                came from an engineer who knows the system inside and out.
              </p>
              <p>
              ...
              <p>
                ...
                single time an agent spins up, they assemble a working model of
                it on the fly, using whatever information you let them load into
          ...
          <section className="mt-12">
            ...
            <div className="flex flex-col gap-4">
              <p>
                ...
                codebase. You plan on moving from an established pattern to a
                new one, using AI Agents to get the job done. You open up Cursor
                or an equivalent environment and type the following:
              </p>
              <p>
                <code>
              ...
              <p>
                After all, what better context could you provide to an agent
              ...
              <p>
                Depending on the complexity / novelty of your request, by the
                time the agent is finished, you will likely experience one of
          ...
          <section className="mt-12">
            ...
            <div className="flex flex-col gap-2">
              ...
              <ol className="list-decimal pl-6">
                <li>
                  Search codebase for examples of Pattern A, adding each
                  instance to the context window
                </li>
                <li>
                  Analyze dependencies by ingesting context of how Pattern A
                  interacts with the rest of the system, adding each file it
                  reads to its context window.
                </li>
                <li>
              ...
              <p>
                You might notice the common thread between each of these steps
                is that each step adds more and more to the context window. As
                the context window grows beyond a certain point, the output of
                the agent begins to deteriorate in quality as a result of the
                ...
                specific, focused steps to reduce the tokens that get loaded
                into context.
              </p>
              <p>Typically, this is best achieved by doing the following:</p>
              <ul className="list-disc pl-6">
                <li>
                  Start by planning. Allow the agent to focus purely on
                  gathering and synthesizing provided context regarding the
                  current system state and goals into a clear and concise plan
                  for implementation.
                </li>
                <li>
                  Once the plan is detailed enough that you feel confident in
                  it, spin up agents to focus on single pieces of the plan at a
                  time, ensuring that an agent doesn&apos;t scope-creep itself
                  into polluting its own context window. If you still
                  aren&apos;t getting the results you want, you probably
                  didn&apos;t divide your work into small enough pieces!
                </li>
              </ul>
              <p>
                As a result of this approach, we are able to optimize steps 1
                and 2 of the agent workflow. Instead of searching your codebase
                for context related to your task, ballooning context quickly, an
                agent is able to reference a concise document and get to work.
              </p>
              <BlogCallout>
                <p>
                  Cursor&apos;s{" "}
                  <a href="https://cursor.com/blog/plan-mode">Plan Mode</a> is a
                  fantastic middle-ground for smaller chunks of work, though you
                  will still see context pollution when making larger requests.
                </p>
              </BlogCallout>
            </div>
          </section>
          ...
          <section className="mt-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                ...
                in your prompt. Once you have all the resources set up,
                it&apos;s time to go!
              </p>
              <BlogCallout>
                <p>
          ...
          <section className="mt-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <BlogCallout>
                <p>
                  AI tools only make this problem worse. Modern tools usually
                  take existing patterns as gospel and will typically not create
                  new patterns that they deem &quot;more efficient&quot; or
                  &quot;scalable&quot; unless guided to do so. As a result, it
                  is our job as developers to catch these anti-patterns early on
                  and steer the tools in a better direction so that the problem
                  does not compound. This issue can often be avoided entirely by
                  ensuring that we declare valuable patterns, libraries, etc...
              ...
              <p>
                ...
                general wackiness that we really shouldn&apos;t need to concern
                ourselves with. This is a problem that Tanstack Query solves way
                better than any agent ever will, so we need to guide its hand so
                that it sees things our way.
              </p>
            </div>
          </section>
          ...
          <section className="mt-12">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p>
                In my case, this step took the form of the following prompt:
              </p>
              <BlogCodeBlock>
...
Only document, do not create anything outside of the specified file.`}
              ...
              <p>
                I recommend that you thoroughly review and iterate on your
                outline until you are confident it has all of the details the
                agent will need to work from.
              </p>
              <p>
                Have a conversation with the AI. If you feel that you
                aren&apos;t confident about one of the above points? Ask it to
                interview you about any of them. Work with it by providing areas
                that you aren&apos;t sure or that <em>you</em> think you need
                clarification.
              </p>
              <h3>Prepare for implementation</h3>
              <p>
                The final step for us is to turn our spec into a list of tickets
                for the agent to iterate through one at a time. This ensures
                that our agents will not go off the rails and update anything
                other than <em>exactly</em> what we tell it to.
              </p>
              <p>
  ...
  DO NOT ADD ANYTHING TO THE JSON FILE OTHER THAN AN ARRAY OF TICKETS`}
              ...
              <div>
                ...
                <ul className="list-disc pl-6">
                  ...
                  <li>
                    Take your learnings and try again! Start a new session at
                    the current, or even previous step. This may sound crazy,
                    but by starting new and clearing the context window, you can
                    remove any bad information or mistakes in prompting that may
                    have caused the previous attempt to go off the rails. The
                    benefit of this approach is that each artifact produce can
                    act as a checkpoint if we ever need to go back to the
                    drawing board
                  </li>
                </ul>
              </div>
          ...
          <section className="mt-12">
            ...
            <div className="flex flex-col gap-4">
              <p>
                ...
                the pieces in place, it&apos;s time to spin up an agent to
                tackle the first task in your PRD. I have a custom Cursor
                command that handles this: <code>/work-on-prd</code>
              </p>
...
If you notice while working on a feature that the PRD is complete, let me know`}
              ...
              <ol className="list-decimal pl-6">
                ...
                <li>
                  ...
                  ticket. <strong>This is so incredibly crucial</strong>. This
                  whole workflow is built around reducing context overload from
                  agent to agent, if you are running through multiple tickets in
                  a session, you are likely leaving quality on the table. If you
                  take away one thing from this article, its that you should be
                  starting new agent sessions often!
                </li>
              </ol>
            </div>
          </section>
          ...
          <section className="mt-12 pb-16">
            ...
            <div className="flex flex-col gap-4">
              <p>
                ...
                article doesn&apos;t talk all that much about tools or code.
                That is a deliberate choice. My goal was to shed light on my
                process. And that process may very well not work for you! These
                tools are ultimately just extensions of the person that is
                piloting them. The only true barrier to execution is creating an
                interface that allows agents to execute things exactly how you
                see them in your mind&apos;s eye.
              </p>
              <p>
                If AI agents feel unpredictable, it&apos;s because we
                haven&apos;t yet implemented the systems to best control how
                they execute.
              </p>
            </div>
          </section>
          <section className="mt-12">
            ...
            <ul className="list-disc pl-6">
              <li>
                ...
                <ul className="list-disc pl-6">
                  <li>
                    <a href="https://cursor.com/blog/plan-mode">Plan Mode</a>{" "}
                    will help you get your plans in a great shape.
                  </li>
                  <li>
              ...
              <li>
                Vercel recently put out a{" "}
                <a href="https://vercel.com/blog/introducing-react-best-practices">
                  fantastic list
                </a>{" "}
                of best practice agent skills for working with React codebases{" "}
              </li>
              <li>
                Theo put out a{" "}
                <a href="https://www.youtube.com/watch?v=Yr9O6KFwbW4">
                  great video
                </a>{" "}
                that talks about many of the concepts I discuss here. He makes a
                fantastic point that instead of fixating on the tools and
                specifics of how we build, we should be focused on internalizing
                the principles and systems of thinking that enable us to provide
                agents with the best context{" "}
              </li>
              <li>
                A{" "}
                <a href="https://www.youtube.com/watch?v=L_p5GxGSB_I">
                  breakdown
                </a>{" "}
                by Lee Robinson on the different ways to provide context to an
                agent
              </li>
              <li>
                Fantastic{" "}
                <a href="https://www.youtube.com/watch?v=-uW5-TaVXu4">video</a>{" "}
                on context from Matt Pocock. Check out his channel for a bunch
                of great info on optimizing your workflow with AI agents.
              </li>
            </ul>
          </section>
        </div>
